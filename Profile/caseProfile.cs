...
namespace WeSafe.Profiles
{
    ...
    public class CaseProfile : Profile
    {
        public CaseProfile()
        {
            ...
            .ForMember(dest => dest.AssignedPoliceId, opt => opt.MapFrom(src => src.AssignedPoliceId))
            .ForMember(dest => dest.AssignedPolice, opt => opt.MapFrom(src => src.AssignedPolice))
            .ForMember(dest => dest.ReporterAdminId, opt => opt.MapFrom(src => src.ReporterAdminId))
